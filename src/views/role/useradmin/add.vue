<template>
  <div class="container-box">
    <el-form class="my-form" :rules="rules" ref="myform" :model="ruleForm" label-width="130px">
      ...
      <el-form-item label="用户名" prop="title" :rules="[ { required: true, message: '请输入用户名', trigger: 'blur' } ]">
      ...
      <el-form-item label="分配角色" prop="radio" :rules="[ { required: true, message: '请选择角色', trigger: 'blur' } ]">
        <el-radio-group size="large" v-model="ruleForm.radio">
          <el-radio style="margin-bottom: 15px" v-for="item in 9" :label="item" border size="medium">超级管理员</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item>
        <div class="but-b">
