<template>
  <div class="comp-container">
    <div class="search-box row-between">
      <router-link :to="'/directseeding/directseedingadminadd'">
    ...
    >
      ...
      <el-table-column label="宣传视频">
        <template slot-scope="scope">
          <div style="height: 300px;display: flex;align-items: center">
            <video :src="scope.row.Imgurl" autoplay controls width="300"></video>
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="scope">
          <div class="operate">
            <el-button type="text" @click="$router.push({path:'/directseeding/directseedingadminedit',query:{id:scope.row.id}}
            )">
              编辑
            </el-button>
