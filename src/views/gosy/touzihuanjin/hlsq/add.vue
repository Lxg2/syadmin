<template>
  <div class="container-box">
    <el-form class="my-form" :rules="rules" ref="myform" :model="ruleForm" label-width="130px">
      <el-form-item label="商圈标题" prop="title">
        <el-input v-model="ruleForm.title" placeholder="请输入商圈标题"></el-input>
      </el-form-item>
      <el-form-item label="商圈内容" prop="content">
      ...
      <el-form-item label="商圈封面" prop="imgurl">
        <el-upload
