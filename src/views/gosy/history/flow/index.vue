<template>
  <div class="comp-container">
    <div class="search-box row-between">
      <router-link :to="'/goshiyan/historyadmin/historyflowadd'">
...
<!-- 
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="scope">
          <div class="operate">
            <el-button type="text" @click="$router.push({path:'/goshiyan/historyadmin/historyflowedit',query:{id:scope.row.id}}
            )">
              编辑
            </el-button>
