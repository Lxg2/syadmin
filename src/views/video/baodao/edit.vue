<template>
    <div class="container-box">
      ...
      <el-form class="my-form" :rules="rules" ref="myform" :model="ruleForm" label-width="130px">
        <el-form-item label="报到标题" prop="title">
          <el-input v-model="ruleForm.title" placeholder="请输入报到标题"></el-input>
        </el-form-item>
        <el-form-item label="党员报到" prop="content">
  ...
  export default {
    ...
    mounted(){
      ...
      GetArtcileInfo({id:this.$route.query.id}).then(res=>{
        let {Title:title,Content:content,Isshow:isshow} = res.datalist
