<template>
  <div class="comp-container">
    <div class="search-box row-between">
      <router-link :to="'/partybuilding/elegantaddsq'">
    ...
    <el-table-column width="10" align="center" />
      <el-table-column width="237px" label="服务站名称" prop="Title">
      </el-table-column>
      ...
      <el-table-column label="负责人昵称" width="150">
        <template slot-scope="scope">
          <span>{{ scope.row.Communityusername }}</span>
        </template>
      </el-table-column>
      <el-table-column label="负责人电话" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="职务" width="150">
        <template slot-scope="scope">
          <span>{{ scope.row.Communitypositon }}</span>
        </template>
      </el-table-column>
      <el-table-column label="所在社区" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" fixed="right" label="操作" width="200">
        <template slot-scope="scope">
          <div class="operate">
            <el-button type="text" @click="$router.push({path:'/partybuilding/eleganteditsq',query:{id:scope.row.id}}
            )">
              编辑
            </el-button>
