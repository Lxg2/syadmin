<template>
  <div class="container-box">
    <!-- 政策模块 -->
    <el-form class="my-form" :rules="rules" ref="myform" :model="ruleForm" label-width="110px">
      <el-form-item label="服务站名称" prop="title">
        <el-input v-model="ruleForm.title" placeholder="请输入服务站名称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="服务站封面" prop="imgurl">
        <el-upload  
...
export default {
  ...
  mounted(){
    ...
    GetArtcileInfo({id:this.$route.query.id}).then(res=>{
      ...
      this.ruleForm.communitypositon = communitypositon
