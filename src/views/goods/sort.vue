<template>
  <div class="sort-container">
    <div class="row-between">
        <span style="font-weight: bold;">自定义字段应用在商品分类上</span>
      <div>
        <el-input v-model="listQuery.title" placeholder="输入关键词搜索" style="width: 360px;"
        class="filter-item item-input" @keyup.enter.native="handleFilter">
        <i slot="prefix" class="el-input__icon el-icon-search"></i></el-input>
        <el-button class="filter-item" style="margin-left: 40px;" size="small" type="primary">
          <router-link :to="'/goods/sort-add'">新增分类</router-link>
        </el-button>
      </div>
    </div>
